...
public class ClientMessaging extends JFrame {
        ...
        public ClientMessaging(String serverIPAddress, String serverPort, String clientIdentifier,
                        String clientIPAddress, String clientPort) {
                super();
                ...
                this.client = new ClientManager(this.primaryMessagePane, this, this.serverDetailsCoordinatorValueLabel,
                                this.serverIPAddress, Integer.parseInt(this.serverPort), this.clientIdentifier,
                                this.clientIPAddress, Integer.parseInt(this.clientPort));
        ...
        private void initComponents() {
                ...
                headerTitlePanelLayout.setVerticalGroup(headerTitlePanelLayout
                                .createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addGroup(GroupLayout.Alignment.TRAILING, headerTitlePanelLayout.createSequentialGroup()
                                                .addGap(15, 15, 15)
                                                .addGroup(headerTitlePanelLayout
                ...
                headerNamePanelLayout.setHorizontalGroup(
                                headerNamePanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(headerNamePanelLayout.createSequentialGroup()
                                                                .addGap(18, 18, 18).addComponent(discussionNetLabel)
                                                                .addContainerGap(18, Short.MAX_VALUE)));
                headerNamePanelLayout.setVerticalGroup(headerNamePanelLayout
                                .createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addGroup(GroupLayout.Alignment.TRAILING, headerNamePanelLayout.createSequentialGroup()
                                                .addGap(14, 14, 14).addComponent(discussionNetLabel)
                                                .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
                ...
                sidePanelLayout.setVerticalGroup(sidePanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addGroup(sidePanelLayout.createSequentialGroup().addGap(27, 27, 27)
                                                .addComponent(clientFeaturesLabel).addGap(18, 18, 18)
                                                .addComponent(userMessagingLabel)
                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED,
                ...
                clientDetailsPanel1Layout.setHorizontalGroup(
                                clientDetailsPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(clientDetailsPanel1Layout.createSequentialGroup()
                                                                .addGap(45, 45, 45).addComponent(clientDetailsIcon)
                                                                .addGap(37, 37, 37).addComponent(clientDetailsLabel1)
                                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                                .addComponent(clientDetailsLabel2)
                                                                .addContainerGap(72, Short.MAX_VALUE)));
                clientDetailsPanel1Layout.setVerticalGroup(clientDetailsPanel1Layout
                                .createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addGroup(clientDetailsPanel1Layout.createSequentialGroup()
                                                .addContainerGap(12, Short.MAX_VALUE).addComponent(clientDetailsIcon)
                                                .addGap(22, 22, 22))
                                .addGroup(clientDetailsPanel1Layout.createSequentialGroup().addGap(35, 35, 35)
                                                .addGroup(clientDetailsPanel1Layout
                                                                .createParallelGroup(GroupLayout.Alignment.BASELINE)
                ...
                clientDetailsPanel2Layout.setHorizontalGroup(clientDetailsPanel2Layout
                                .createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addGroup(clientDetailsPanel2Layout.createSequentialGroup().addGap(41, 41, 41)
                                                .addGroup(clientDetailsPanel2Layout
                                                                .createParallelGroup(GroupLayout.Alignment.LEADING)
                ...
                clientDetailsPanel2Layout.setVerticalGroup(clientDetailsPanel2Layout
                                .createParallelGroup(GroupLayout.Alignment.LEADING)
                ...
                serverDetailsCoordinatorLabel
                                .setText("Server Coordinator");
                ...
                serverDetailsPanel1Layout.setHorizontalGroup(
                                serverDetailsPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(serverDetailsPanel1Layout.createSequentialGroup()
                                                                .addGap(36, 36, 36).addComponent(serverDetailsIcon)
                                                                .addGap(39, 39, 39).addComponent(serverDetailsLabel1)
                                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                ...
                serverDetailsPanel1Layout.setVerticalGroup(serverDetailsPanel1Layout
                                .createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addGroup(serverDetailsPanel1Layout.createSequentialGroup()
                                                .addGroup(serverDetailsPanel1Layout
                                                                .createParallelGroup(GroupLayout.Alignment.LEADING)
                                                                .addGroup(serverDetailsPanel1Layout
                ...
                serverDetailsPanel2Layout.setHorizontalGroup(serverDetailsPanel2Layout
                                .createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addGroup(serverDetailsPanel2Layout.createSequentialGroup().addGap(39, 39, 39)
                                                .addGroup(serverDetailsPanel2Layout.createParallelGroup(
                                                ...
                                                .addGap(37, 37, 37)));
                serverDetailsPanel2Layout.setVerticalGroup(serverDetailsPanel2Layout
                ...
                userMessagingTopPanelLayout.setHorizontalGroup(userMessagingTopPanelLayout
                                ...
                                .addGroup(userMessagingTopPanelLayout.createSequentialGroup().addGap(295, 295, 295)
                                                .addComponent(userMessagingIconLabel).addGap(18, 18, 18)
                ...
                layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout
                                ...
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                                                .addComponent(headerNamePanel, GroupLayout.DEFAULT_SIZE, 154,
                                                                Short.MAX_VALUE)
                                                .addComponent(sidePanel, GroupLayout.DEFAULT_SIZE,
                                                                GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addComponent(footerPanel, GroupLayout.DEFAULT_SIZE,
                                                                GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addGroup(layout.createSequentialGroup().addGap(2, 2, 2).addComponent(
                                                                headerTitlePanel, GroupLayout.DEFAULT_SIZE,
                                                                GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                                .addGroup(layout.createSequentialGroup().addGap(12, 12, 12)
                                                                .addGroup(layout.createParallelGroup(
                                                                                GroupLayout.Alignment.LEADING)
                                                                                .addGroup(layout.createSequentialGroup()
                                                                                                .addComponent(serverDetailsPanel1,
                                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                                334,
                                                                                                                GroupLayout.PREFERRED_SIZE)
                                                                                                .addGap(2, 2, 2)
                                                                                                .addComponent(serverDetailsPanel2,
                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                576,
                                                                                                                Short.MAX_VALUE))
                                                                                .addGroup(layout.createSequentialGroup()
                                                                                                .addComponent(clientDetailsPanel1,
                                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                                334,
                                                                                                                GroupLayout.PREFERRED_SIZE)
                                                                                                .addGap(2, 2, 2)
                                                                                                .addComponent(clientDetailsPanel2,
                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                Short.MAX_VALUE))
                                                                                .addComponent(userMessagingTopPanel,
                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                912, Short.MAX_VALUE))
                                                                .addGap(12, 12, 12))
                                                .addGroup(layout.createSequentialGroup().addPreferredGap(
                                                                ...
                                                                .addGroup(layout.createParallelGroup(
                                                                                GroupLayout.Alignment.LEADING)
                                                                                .addComponent(userMessagingMainPanel,
                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                Short.MAX_VALUE)
                ...
                layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout
                                ...
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                                .addComponent(headerNamePanel, GroupLayout.DEFAULT_SIZE, 49,
                                                                Short.MAX_VALUE)
                                                .addComponent(headerTitlePanel, GroupLayout.DEFAULT_SIZE,
                                                                GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout
                                                ...
                                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                                ...
                                                                .addComponent(serverDetailsPanel2,
                                                                                ...
                                                                                GroupLayout.PREFERRED_SIZE))
                                                .addGap(12, 12, 12)
                                                .addComponent(userMessagingTopPanel, GroupLayout.PREFERRED_SIZE, 76,
                                                                GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(primaryMessagePane, GroupLayout.DEFAULT_SIZE, 312,
                                                                Short.MAX_VALUE)
                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                ...
                                                .addComponent(sidePanel, GroupLayout.DEFAULT_SIZE, 713,
                                                                Short.MAX_VALUE))));
        ...
        private void sendMessage() {
                ...
                String messageRecipient = this.primaryMessagePane
                                .getTitleAt(this.primaryMessagePane.getSelectedIndex());
